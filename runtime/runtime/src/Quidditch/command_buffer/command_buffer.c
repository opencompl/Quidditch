...
typedef struct quidditch_command_buffer_t {
...
} quidditch_command_buffer_t;

static const iree_hal_command_buffer_vtable_t quidditch_command_buffer_vtable;

static quidditch_command_buffer_t* quidditch_command_buffer_cast(
    iree_hal_command_buffer_t* base_value) {
  IREE_HAL_ASSERT_TYPE(base_value, &quidditch_command_buffer_vtable);
  return (quidditch_command_buffer_t*)base_value;
}

static void quidditch_command_buffer_reset(
...
iree_status_t quidditch_command_buffer_initialize(
  ...
  *out_command_buffer = NULL;
  ...
  quidditch_command_buffer_t* command_buffer =
      (quidditch_command_buffer_t*)storage.data;
...
void quidditch_command_buffer_deinitialize(
...
iree_status_t quidditch_command_buffer_create(
    iree_hal_device_t* device, iree_hal_command_buffer_mode_t mode,
    iree_hal_command_category_t command_categories,
    iree_hal_queue_affinity_t queue_affinity, iree_host_size_t binding_capacity,
    iree_allocator_t host_allocator,
...
static void quidditch_command_buffer_destroy(
    iree_hal_command_buffer_t* base_command_buffer) {
  quidditch_command_buffer_t* command_buffer =
      quidditch_command_buffer_cast(base_command_buffer);
  ...
  quidditch_command_buffer_deinitialize(base_command_buffer);
  iree_allocator_free(host_allocator, command_buffer);

  IREE_TRACE_ZONE_END(z0);
}

bool quidditch_command_buffer_isa(iree_hal_command_buffer_t* command_buffer) {
  return iree_hal_resource_is(&command_buffer->resource,
                              &quidditch_command_buffer_vtable);
}

//===----------------------------------------------------------------------===//
// quidditch_command_buffer_t recording
//===----------------------------------------------------------------------===//

// Updates the cached processor ID field in the command buffer.
static void quidditch_command_buffer_update_processor_id(
    quidditch_command_buffer_t* command_buffer) {
  iree_cpu_requery_processor_id(&command_buffer->state.processor_tag,
                                &command_buffer->state.processor_id);
}

static iree_status_t quidditch_command_buffer_begin(
    iree_hal_command_buffer_t* base_command_buffer) {
  quidditch_command_buffer_t* command_buffer =
      quidditch_command_buffer_cast(base_command_buffer);
  quidditch_command_buffer_reset(command_buffer);
  ...
  quidditch_command_buffer_update_processor_id(command_buffer);

  return iree_ok_status();
}

static iree_status_t quidditch_command_buffer_end(
    iree_hal_command_buffer_t* base_command_buffer) {
  quidditch_command_buffer_t* command_buffer =
      quidditch_command_buffer_cast(base_command_buffer);
  quidditch_command_buffer_reset(command_buffer);
...
static iree_status_t quidditch_command_buffer_signal_event(
...
static iree_status_t quidditch_command_buffer_reset_event(
    iree_hal_command_buffer_t* base_command_buffer, iree_hal_event_t* event,
    iree_hal_execution_stage_t source_stage_mask) {
  // No-op; we execute synchronously.
  return iree_ok_status();
...
static iree_status_t quidditch_command_buffer_wait_events(
    iree_hal_command_buffer_t* base_command_buffer,
...
static const iree_hal_command_buffer_vtable_t quidditch_command_buffer_vtable =
    {
        .destroy = quidditch_command_buffer_destroy,
        .begin = quidditch_command_buffer_begin,
        .end = quidditch_command_buffer_end,
        .begin_debug_group = quidditch_command_buffer_begin_debug_group,
        .end_debug_group = quidditch_command_buffer_end_debug_group,
        .execution_barrier = quidditch_command_buffer_execution_barrier,
